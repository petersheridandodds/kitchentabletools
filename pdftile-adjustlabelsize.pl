#!/usr/bin/perl
$usage = "pdftile m n widthfrac hspacepts vspacepts f textsize maintitle title1 fig1.pdf [title2 fig2.pdf ...] outfile

**** the difference here is the fontsize is set to 12pt, and the labels are modified size by textsize
i.e. set it the Large
...
print TEXFILE "\\documentclass[12pt]{extarticle}
